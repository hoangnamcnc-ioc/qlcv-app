...
const LEX = {
  ...
  orderAsc: [" it ", "it nhat", "it viec", "thap", " kem", "yeu", "roi rai", "te nhat", "do nhat", "kem nhat", "thap nhat", "dung cuoi", "cuoi bang", "bet nhat", "yeu nhat", "chot bang"],
  orderDesc: ["nhieu", " cao", " tot", "gioi", " top", "hang dau", "dung dau", "manh nhat", "xuat sac", "vuot troi", "dan dau", "gioi nhat", "cao nhat", "tot nhat", "nhieu nhat", "lon nhat", "dinh nhat", "so mot", "so 1"],
