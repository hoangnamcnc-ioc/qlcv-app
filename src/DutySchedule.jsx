...
export default function DutySchedule({ currentUser, employees, userDept, isMobile, inp, showToast, canManage }){
  ...
  return(<div style={{display:"flex",flexDirection:"column",gap:14}}>
    ...
    {swapModal&&(<div onClick={()=>setSwapModal(null)} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:isMobile?"flex-end":"center",justifyContent:"center",zIndex:65,padding:isMobile?0:16}}><div onClick={e=>e.stopPropagation()} style={{background:"#fff",borderRadius:isMobile?"12px 12px 0 0":14,width:"100%",maxWidth:460,maxHeight:"90vh",overflowY:"auto",boxShadow:"0 12px 40px rgba(0,0,0,0.2)"}}>
