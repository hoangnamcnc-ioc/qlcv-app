...
export const SUPPORT_CHANNELS = {phone:{label:"Điện thoại",icon:"📞"},zalo:{label:"Zalo",icon:"💬"},email:{label:"Email",icon:"📧"},paht:{label:"Tiếp nhận qua HT PAHT",icon:"🖥️"}};
...
// Tab "Hỗ trợ ND & PAHT" dùng đủ 4 kênh ; tab "Xử lý lỗi TTDL" chỉ Điện thoại/Zalo
export const SUPPORT_CHANNELS_BY_CATEGORY = {support:["phone","zalo","email","paht"],datacenter:["phone","zalo"]};
export const SUPPORT_CONTENT_LABEL = {support:"Nội dung hỗ trợ",datacenter:"Mô tả lỗi"};
export const SUPPORT_CATEGORIES = {support:{label:"Hỗ trợ người dùng và xử lý PAHT",icon:"🎧"},datacenter:{label:"Xử lý lỗi Trung tâm dữ liệu",icon:"🖧"}};
