...
export const SUPPORT_CHANNELS = {phone:{label:"Điện thoại",icon:"📞"},zalo:{label:"Zalo",icon:"💬"}};
...
export const SUPPORT_CATEGORIES = {support:{label:"Hỗ trợ người dùng/PAHT và vận hành DC",icon:"🎧"},datacenter:{label:"Xử lý lỗi Trung tâm dữ liệu",icon:"🖧"}};
