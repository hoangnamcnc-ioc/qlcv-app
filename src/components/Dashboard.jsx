...
import { DEPTS, DEPT_COLOR, deptLabel, isRankable, ROLE_COLORS, FULL_ACCESS, STATUS, STATUS_ORDER, FREQUENCIES, RATING, PRIO, VI_MONTHS } from "../constants";
...
export default function Dashboard({
  ...
  const rosterEmps = isManagerView ? (employees || []).filter(e => (FULL_ACCESS.includes(currentUser.role) || e.dept === userDept) && isRankable(e)).slice().sort((a, b) => a.dept === b.dept ? a.name.localeCompare(b.name) : a.dept.localeCompare(b.dept)) : [];
  const ROSTER_SIZE = 8;
